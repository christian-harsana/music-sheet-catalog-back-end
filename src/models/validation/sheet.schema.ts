...
export const createSheetSchema = z.object({
	body: z.object({
		...
		genreId: z
			...
			.nullable()
			.optional(),
		examPiece: z.boolean().default(false),
	}),
	user: z.object({
...
export const getSheetSchema = z.object({
	...
	query: z.object({
		...
		keyQuery: z.string().trim().optional(),
		levelQuery: z.string().trim().optional(),
		genreQuery: z.string().trim().optional(),
		examPieceQuery: z.coerce.boolean().optional(),
	}),
});
